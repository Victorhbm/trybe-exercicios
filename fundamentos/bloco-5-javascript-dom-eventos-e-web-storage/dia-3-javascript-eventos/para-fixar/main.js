...
addEventListener("click", changeClassName)
function changeClassName(eventoDeOrigem) {
	logica = eventoDeOrigem.target;
	if (logica == firstLi) {
		firstLi.classList.add("tech")
		secondLi.classList.remove("tech")
		thirdLi.classList.remove("tech")
	} else if (logica == secondLi) {
		secondLi.classList.add("tech")
		firstLi.classList.remove("tech")
		thirdLi.classList.remove("tech")
	} else if (logica == thirdLi) {
...
myWebpage.addEventListener('dblclick', function() {
	window.location.assign('https://victorhbm.github.io/');
})
